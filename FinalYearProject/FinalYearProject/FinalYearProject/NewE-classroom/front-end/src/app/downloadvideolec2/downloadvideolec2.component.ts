...
import{Downloadvideolec2Service} from "src/app/downloadvideolec2/downloadvideolec2.service"
import { Profile } from "src/app/models/profile";
import { CurrentrouteService } from '../currentroute.service';
import { LoginService } from '../user/login/login.service';
@Component({
  selector: 'app-downloadvideolec2',
  templateUrl: './downloadvideolec2.component.html',
  styleUrls: ['./downloadvideolec2.component.css']
})
export class Downloadvideolec2Component implements OnInit,OnDestroy {
 sem :any;
 subject:any;
 imagePath:any;
 chapter:any;
 profiles: Profile[] = [];
  ...
  constructor(private http:HttpClient,
   private service: Downloadvideolec2Service,
