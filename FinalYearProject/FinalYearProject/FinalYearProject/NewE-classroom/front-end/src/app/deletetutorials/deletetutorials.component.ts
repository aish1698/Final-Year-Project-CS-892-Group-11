...
@Component({
  selector: 'app-deletetutorials',
  templateUrl: './deletetutorials.component.html',
  styleUrls: ['./deletetutorials.component.css']
})
export class DeletetutorialsComponent implements OnInit {
